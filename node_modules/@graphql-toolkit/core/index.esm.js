...
import { debugLog, asArray, isDocumentString, parseGraphQLSDL, printSchemaWithDirectives, fixSchemaAst } from '@graphql-toolkit/common';
...
import { printWithComments, mergeSchemasAsync } from '@graphql-toolkit/schema-merging';
...
async function loadSchema(schemaPointers, options) {
    ...
    return mergeSchemasAsync(Object.assign({ schemas,
        typeDefs }, options));
}
