...
async function collectDefinitions(imports, documentSource, options) {
    ...
    await Promise.all(rawModules.map(async (m) => {
        ...
        const moduleFilePath = resolveModuleFilePath(path.resolve(options.cwd, documentSource.location), m.from);
...
async function loadSchema(schemaPointers, options) {
    ...
    return schemaMerging.mergeSchemasAsync(Object.assign({ schemas,
        typeDefs }, options));
}
